...
return [
    ...
    'no_languages' => 'No existen idiomas',
    'no_series' => 'No existen series',

    'list_title' => [
        'platform' => 'Listado de plataformas',
        'actor' => 'Listado de actores',
        'director' => 'Listado de directores',
        'language' => 'Listado de idiomas',
        'series' => 'Listado de series',
    ],
    'create_title' => [
        'platform' => 'Crear plataforma',
        'actor' => 'Crear actor',
        'director' => 'Crear director',
        'language' => 'Crear idioma',
        'series' => 'Crear serie',
    ],
    'edit_title' => [
        'platform' => 'Editar plataforma',
        'actor' => 'Editar actor',
